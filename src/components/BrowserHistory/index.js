...
class BrowserHistory extends Component {
  ...
  render() {
    ...
    const historyLength = updatedHistoryList.length

    return (
      <div className="browser-history-app-container">
        <div className="browser-history-top-container">
          <img
        ...
        <div className="browser-history-body">
          {historyLength > 0 ? (
            <ul className="history-list-contianer">
